...
**Дальше:** оракул задуман как переиспользуемая инфраструктура — не только для нашего собственного агента, а как публичный сервис безопасности для любого агента на Casper, готового платить $0.001 за проверку перед транзакцией.
