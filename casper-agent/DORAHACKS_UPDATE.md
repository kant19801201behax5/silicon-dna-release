...
- [0:22–0:40] Casper Testnet Explorer: 962 confirmed `oracle.update()` transactions on the original contract (the active contract has since added 11,340 more — 12,302 total as of 2026-08-27). Contract in Rust (casper-contract 5.1.1, native WASM — no Odra abstraction layer).
...
**Active contract, re-verified from live logs 2026-08-27 19:48 UTC:** **11,340** `update()` calls,
**170** safety pauses, **425 CSPR** of gas saved by not transacting while unsafe — agent up
**57,808 min** continuously with **0 restarts**. Running total across both contracts: **12,302** updates.
...
- **On-chain (active contract, as of 2026-08-27 19:48 UTC):** **11,340** confirmed updates · **170** safety pauses · **425 CSPR** gas saved · **57,808 min** uptime, 0 restarts — all re-derived from live logs
...
smart contract continuously — **11,340 autonomous on-chain calls**, this is not in question. What it
